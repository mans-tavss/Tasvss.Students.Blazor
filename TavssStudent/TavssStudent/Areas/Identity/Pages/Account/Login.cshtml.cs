...
using TavssStudent.Areas.Identity.Data;
using System.Text;
using Microsoft.AspNetCore.WebUtilities;

namespace TavssStudent.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<StudentUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (InputLogin.Email != null && InputLogin.Password != null)
            {
        ...
        public async Task<IActionResult> OnPostRegister(string returnUrl = null)
        {
            returnUrl = returnUrl ?? Url.Content("~/");
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            if (InputRegister.Email != null && InputRegister.Password != null &&
                InputRegister.ConfirmPassword != null && InputRegister.Phone != null &&
                InputRegister.FullName != null && InputRegister.Password == InputRegister.ConfirmPassword)
            {
                var user = new StudentUser
                {
                    UserName = InputRegister.Email,
